...
class GalleryHtmlPage(HtmlPage):
    ...
    def __init__(self, sTitle, sPath = ''):
        ...
        super().__init__('TF79.ch &mdash;  Galeries &mdash;  ' + sTitle, 'http://www.tf79.ch/scripts/style.css')
    ...
    def buildMenu(self):
        ...
        self.menu.addTag(HtmlTag('h3', '<a href="http://www.tf79.ch/gallery/voyages/index.html">Voyages</a>'))
        self.menu.addTag(HtmlTag('h3', '<a href="http://www.tf79.ch/gallery/nihon/index.html">Japon</a>'))
        self.menu.addTag(HtmlTag('h3', '<a href="http://www.tf79.ch/gallery/suisse/index.html">Suisse</a>'))
